...
?>
	...
	<div class="banner-wrapper">
		<div class="bg-banner"></div>
			...
			<h1>Fejl og fakta</h1>
			<p>I Berlingske og på B.dk bestræber vi os dagligt på at give overblik, indsigt og hastig nyhedsopdatering. For os er det en klar målsætning at være præcise samt at undgå fejl og misforståelser.</p>

<p>Troværdighed er en kerneværdi for Berlingske. Laver vi fejl, retter vi dem så hurtigt som muligt, og rettelser vil fremgå både af de enkelte artikler og af denne side.</p>

<p>Kontakt os på fejlogfakta2@berlingske.dk</p>

<p>Læs også Berlingske Medias regler for journalistisk etik</p>
